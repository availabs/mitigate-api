SELECT id, cousub_geoid, c.geoid as tract_geoid, objectid, county_nam, muni_name, swis, parcel_add, 
       ...
       nys_name_s, dup_geo, calc_acres, shape_leng, shape_area, wkb_geometry
  into parcel.parcel_2017_36_temp
  FROM parcel.parcel_2017_36 as a
  join geo.tl_2017_blockgroup as c on ST_CONTAINS(ST_Transform(c.geom,4326), a.wkb_geometry);
